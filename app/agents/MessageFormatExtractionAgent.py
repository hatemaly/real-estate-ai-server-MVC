...
class PropertyStats(BaseModel):
    bedrooms: Optional[int] = Field(
        default=None, description="Number of bedrooms in the property"
    )
    bathrooms: Optional[int] = Field(
        default=None, description="Number of bathrooms in the property"
    )
    square_footage: Optional[int] = Field(
        default=None, description="Square footage of the property"
    )
    parking_spaces: Optional[int] = Field(
        default=None, description="Number of parking spaces in the property"
    )
    garden: Optional[bool] = Field(
        default=None, description="Whether the property has a garden"
    )
    swimming_pool: Optional[bool] = Field(
        default=None, description="Whether the property has a swimming pool"
    )
...
class PriceRange(BaseModel):
    ...
    currency: Optional[CurrencyType] = Field(
        default=CurrencyType.EGP, description="Currency of the price (USD, EUR, etc.)"
    )
...
class RealEstateExtractionsSchema(BaseModel):
    ...
    refactored_message: Optional[str] = Field(
        None, description="The refactored version of the user message."
    )
    ...
    def __init__(self):  # Fixed constructor syntax
        self.llm = ChatGoogleGenerativeAI(
            ...
            google_api_key=os.getenv(
                "GEMINI_API_KEY", "AIzaSyBw2Z9hujaI2ay3-mdyQwklUWJ2pt-ho5g"
            ),
        )
        ...
        self.output_parser = PydanticOutputParser(
            pydantic_object=RealEstateExtractionsSchema
        )
